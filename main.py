...
# setting custom tab
st.set_page_config(page_title='Find Worth of your Car', page_icon='🚗')

# creating car model brand list.
# loading the dataset.
...
# writing header
st.markdown("<h2 style='text-align: center;'> Find Worth of your Car </h2>", unsafe_allow_html=True)
...
predict = col1.button('Predict') # creating a predict button
